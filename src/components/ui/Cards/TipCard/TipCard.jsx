import { RiAlarmLine, RiBrainLine, RiCalendarLine, RiGitRepositoryLine, RiLightbulbLine, RiLineChartLine } from "@remixicon/react";
        ...
        <div className="w-full min-h-[50px] bg-transparent border border-[#2a2a2a] rounded-lg p-1">
            <div className="w-full h-full bg-linear-to-t from-transparent to-[#2a2a2a] rounded-md p-4">
                ...
                <div className="w-full flex flex-col gap-1 md:gap-2 flex-initial">
                    <h3 className="text-base font-semibold text-[#ffffff] md:text-xl">Pomodoro Technique</h3>
                    <p className="text-sm font-normal text-[#8e8e8e]">A method of studying for 25 minutes followed by a 5-minute break to improve focus and reduce fatigue.</p>
                </div>
            </div>
        </div>
    );
